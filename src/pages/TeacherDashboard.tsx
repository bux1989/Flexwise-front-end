      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <LessonsElement
            ...
            isMobile={isMobile}
            showAllLessonsOnMobile={showAllLessonsOnMobile}
            expandedMobileLessonDetails={expandedMobileLessonDetails}
            onDateSelect={handleDateSelect}
            onTodayClick={handleTodayClick}
            onToggleShowAllLessons={setShowAllLessonsOnMobile}
            onToggleMobileLessonDetails={toggleMobileLessonDetails}
            onAttendanceClick={handleAttendanceClick}
            needsAttendanceTracking={needsAttendanceTracking}
            getAttendanceStatus={getAttendanceStatus}
            getAttendanceNumbers={getAttendanceNumbers}
            getAttendanceSummary={getAttendanceSummary}
            getMobileSubjectAbbreviation={getMobileSubjectAbbreviation}
            getMobileTeacherAbbreviation={getMobileTeacherAbbreviation}
          />
