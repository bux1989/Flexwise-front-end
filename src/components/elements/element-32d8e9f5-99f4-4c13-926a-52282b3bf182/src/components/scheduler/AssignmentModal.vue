    ...
    <div v-if="visible" class="assignment-modal-backdrop" @click="$emit('close')">
        <div class="assignment-modal" @click.stop>
                ...
                <template v-else>
                    ...
                    <div class="context-row" v-if="preSelectedCourse">
                        <div class="context-chip">
                            Day: <strong>{{ formattedDay }}</strong>
                        </div>
                        <div class="context-chip">
                            Period: <strong>{{ formattedPeriod }}</strong>
                        </div>
                    </div>
                    ...
                    <p class="freq-warning" v-if="frequencyChecked">
                        Multiple times per week means some children, teachers, and the room may be shared across
                        repeated sessions. The course will remain in the Available list so you can add another
                        occurrence.
                    </p>
                    ...
                    <div class="section">
                        ...
                        <div class="teacher-list">
                            <label v-for="t in teachers" :key="t.id" class="teacher-item">
            ...
            <div class="modal-footer">
                ...
                <button v-if="!isReadOnly" @click="submit" class="btn btn-primary">Assign Course</button>
            </div>
        </div>
    </div>
</template>
