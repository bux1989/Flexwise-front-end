            ...
            <div class="modal-body">
                    ...
                    <div v-if="selectedTeachers.length > 0" class="selected-items">
                        ...
                        <div class="selected-teacher-tags">
                            ...
                            >
                                ...
                                <span v-if="isPrimary(teacherId)" class="primary-indicator" title="Primary teacher"
                                    >★</span
                                >
                                <button @click="removeTeacher(teacherId)" class="remove-btn" title="Remove teacher">
                                    &times;
                                </button>
                            </div>
                        </div>
                ...
                <div class="selection-section scheduling-options">
                    ...
                    <p id="recurring-help" class="help-text">
                        If checked, you can add this course to multiple day/period slots without it being hidden from
                        the Available list.
                    </p>
                </div>
                    ...
                    <div class="compact-selector">
                        ...
                        <div v-if="selectedTeachers.length > 1" class="primary-teacher-section">
                            ...
                            <select v-model="primaryTeacherId" class="primary-select">
                                <option v-for="teacherId in selectedTeachers" :key="teacherId" :value="teacherId">
