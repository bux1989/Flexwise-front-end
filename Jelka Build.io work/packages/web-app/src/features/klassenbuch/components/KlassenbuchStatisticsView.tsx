...
} from '../data/klassenbuchDataAdapter';
...
export function KlassenbuchStatisticsView({ selectedClass, onViewTypeChange, selectedStudent = '', onStudentSelect }: KlassenbuchStatisticsViewProps) {
