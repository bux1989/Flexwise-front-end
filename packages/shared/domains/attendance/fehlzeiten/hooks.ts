// Attendance tracking hooks for Fehlzeiten module
...
// Custom hooks for attendance functionality
export function useAttendanceStatus(lesson: Lesson): 'none' | 'incomplete' | 'complete' {
...
export function useAttendanceNumbers(lesson: Lesson) {
  // Use real attendance badge data if available
  if (lesson.attendanceBadge) {
...
export function useAttendanceSummary(lesson: Lesson) {
  // Use real attendance badge data if available
  if (lesson.attendanceBadge) {
    return {
...
export function useAttendanceTracking(lessonTime: string, lessonEndTime: string, selectedDate: Date, isCurrent: boolean = false): boolean {
